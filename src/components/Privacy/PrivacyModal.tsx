          ...
          <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
            ...
            <ul className="space-y-2 text-sm text-foreground-muted">
              <li className="flex gap-2">
                ...
                <span>
                  <strong className="text-foreground">Job Finder</strong> — Uses SerApi to search job listings.
              ...
              <li className="flex gap-2">
                <span className="text-blue-500">•</span>
                <span>
                  <strong className="text-foreground">Web Research</strong> — Uses Tavily for company research.
          ...
          <div className="p-4 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-200 dark:border-amber-800">
            ...
            <ul className="space-y-2 text-sm text-foreground-muted">
              <li className="flex gap-2">
                ...
                <span>
                  <strong className="text-foreground">Use it ethically and responsibly</strong> —
              ...
              <li className="flex gap-2">
                ...
                <span>
                  <strong className="text-foreground">Accept it as-is</strong> —
              ...
              <li className="flex gap-2">
                <Heart className="w-4 h-4 text-amber-600 dark:text-amber-400 flex-shrink-0 mt-0.5" />
                <span>
                  <strong className="text-foreground">Respect the spirit of the project</strong> —
